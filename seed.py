...
with app.app_context():
    ...
    product1 = Product(
        ...
        category=category3,
        company=company1,
        description="Garnier face creams are skincare product designed to hydrate, nourish, and improve skin appearance. They are formulated with ingredients like aloe vera and vitamin C.",
    ...
    product2 = Product(
        ...
        photo_url="https://threebs.co/cdn/shop/product/garnier-sakura-white-pinkish-glow-foam-100ml-IMG1-20201016_300x300.jpg?v=1602783117"
    )
    ...
    product5 = Product(
        ...
        photo_url="https://threebs.co/cdn/shop/product/CER-TON-DAIL-355ml-IMG1-v2_300x300.jpg?v=1599143676"
    )
